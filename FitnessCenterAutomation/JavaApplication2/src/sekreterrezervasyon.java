...
public class sekreterrezervasyon extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel7.setText("Antrenör Saatleri");
    ...
    private void jButton2MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton2MousePressed
        try {
            sekretereslesKaldır myForm = new sekretereslesKaldır();
    ...
    public void displayAntrenor() throws SQLException {
        ...
        try (Connection Con = DriverManager.getConnection(
                ...
                ResultSet rs = st.executeQuery("SELECT name, verdigiDers, ogrenciSayisi FROM dersEslestirme")) {
    ...
    public void displayCustomer() throws SQLException {
        ...
        try (Connection Con = DriverManager.getConnection(
                ...
                "pscale_pw_2QyPbaQViAG5k6JgsBdbvKXkBkeGi6h8OKgMWImpieg"); 
            Statement st = Con.createStatement(); 
            ResultSet rs = st.executeQuery("SELECT isim, soyisim, abonelikBitis, TC FROM Musteri")) {
            ResultSetMetaData metaData = rs.getMetaData();
            int columnCount = metaData.getColumnCount();
            String[] columnNames = new String[columnCount];
            columnNames[0] = "İsim";
